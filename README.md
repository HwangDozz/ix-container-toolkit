...
- `profiles/iluvatar-bi-v150.yaml`、`profiles/ascend-910b.yaml` 和 `profiles/metax-c500.yaml` 是当前仓库里的已知样本
...
- Metax C500 已完成 MACA PyTorch backend 与 xpu-runtime 验证；无显式 selector env 的 xpu-runtime 重测仍待执行
